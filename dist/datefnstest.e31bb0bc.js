...
var tomorrow = (0, _dateFns.addDays)(date, 1);
document.write(tomorrow + "<br>");
var result = (0, _dateFns.format)(new Date(2021, 5, 15), 'MM/dd/yyyy');
document.write(result + "<br>");
document.write((0, _dateFns.formatDistanceToNow)(new Date(result)) + ' ago<br>');
var sub1 = new Date(2021, 5, 13);
var sub2 = new Date(2021, 5, 10);
var sub3 = new Date(2021, 5, 11);
var dateArr = new Array();
dateArr.push(sub1, sub2, sub3);
document.write("<br>");

function print(input) {
  for (var i = 0; i < input.length; i++) {
    document.write((0, _dateFns.getMonth)(input[i]) + 1 + "/" + (0, _dateFns.getDate)(input[i]) + "/" + (0, _dateFns.getYear)(input[i]) + "<br>");
  }
}

print(dateArr);
dateArr.sort(_dateFns.compareAsc);
document.write("<br>sorting...<br>");
print(dateArr);
var formatTest = new Date(2021, 4, 31);
document.write("<br>" + formatTest);
document.write("<br>" + (0, _dateFns.formatDistanceToNow)(formatTest));
var obj1 = {
  name: "task 2",
...
var obj2 = {
  name: "task 1",
  due: new Date(2021, 5, 13)
};
var objArr = new Array();
objArr.push(obj1, obj2);
document.write("<br><br>");

function printname(input) {
  for (var i = 0; i < input.length; i++) {
    document.write(input[i].name + ": due in " + (0, _dateFns.formatDistanceToNow)(input[i].due) + "<br>");
  }

  document.write("<br>");
} //could use the following code to sort by due date
...
//# sourceMappingURL=/datefnstest.e31bb0bc.js.map